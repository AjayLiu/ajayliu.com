            ...
            <AccordionItem>
                ...
                <AccordionItemPanel>
                    <p>
                        ...
                        the code to React and Next.js, written in TypeScript. This site is hosted on Netlify and all 
                        the code to this website can be found on my <a href = "https://github.com/ajayliu">github</a>.
                    </p>
                </AccordionItemPanel>
            </AccordionItem>
        </Accordion>
